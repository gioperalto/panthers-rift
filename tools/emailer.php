<?php
	...
	function sendSponsorEmail($admin_name, $admin_email, $sponsor_email, $subject, $message) {
		//INITIALIZE MAILER
		$mail = new PHPMailer;
		...
		$mail->From = 'admin@panthersrift.com';
		$mail->FromName = 'Panther\'s Rift';
		$mail->addAddress($sponsor_email,$name);
		$mail->addReplyTo('admin@panthersrift.com','Panther\'s Rift');
				                                        ...
				                                        <tr>
				                                            <td style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
				                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
				                                                    <tr>
				                                                        <td align="left" valign="middle" class="introductionHeading" style="mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #000;font-size: 14px;font-weight: bold;line-height: 150%;padding-left: 40px;">
				                                                            <h1 style="margin: 0;padding: 0;font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif;color: #EAEAEA;font-size: 44px;font-weight: 500;line-height: 115%;text-align: left;">'
				                                                            . $subject .
				                                                            '</h1>
				                                                        </td>
				                                                    </tr>
	...
	function sendAdminSponsorEmail($sponsor_name, $sponsor_email, $message) {
		//INITIALIZE MAILER
		$mail = new PHPMailer;
		...
		$mail->From = $sponsor_email;
		$mail->FromName = $sponsor_name;
		$mail->addAddress('panthersrift@gmail.com','Panther\'s Rift');
		$mail->addReplyTo($sponsor_email,$sponsor_name);
		...
		$mail->Subject 	= 'Panther\'s Rift - Sponsor Inquiry';
		$mail->Body 	= $body;
		$mail->AltBody 	= $message;
